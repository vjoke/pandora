...
#[cfg(feature = "std")]
use primitives::{
    crypto::Pair, hexdisplay::HexDisplay, offchain::OffchainExt, storage::ChildStorageKey,
    traits::KeystoreExt,
};
...
#[cfg(feature = "std")]
pub type TestExternalities =
    substrate_state_machine::TestExternalities<primitives::Blake2Hasher, u64>;
