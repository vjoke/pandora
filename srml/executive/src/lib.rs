...
where
    ...
    CheckedOf<Block::Extrinsic, Context>:
        Applyable<AccountId = System::AccountId> + GetDispatchInfo,
...
mod tests {
    ...
    use sr_primitives::{
        ...
        weights::Weight,
        ApplyError, DispatchError, Perbill,
    };
    use support::{
    ...
    type Executive =
        super::Executive<Runtime, Block<TestXt>, system::ChainContext<Runtime>, Runtime, ()>;
    ...
    fn balance_transfer_dispatch_works() {
        ...
        t.execute_with(|| {
            ...
            assert!(r.is_ok());
            assert_eq!(
                <balances::Module<Runtime>>::total_balance(&1),
                142 - 10 - weight
            );
        ...
        new_test_ext(1).execute_with(|| {
            Executive::execute_block(Block {
                header: Header {
                    ...
                    number: 1,
                    state_root: hex!(
                        "f0d1d66255c2e5b40580eb8b93ddbe732491478487f85e358e1d167d369e398e"
                    )
                    .into(),
                    extrinsics_root: hex!(
    ...
    fn block_weight_and_size_is_stored_per_tx() {
        ...
        let x1 = sr_primitives::testing::TestXt(
            sign_extra(1, 1, 0),
            Call::Balances(BalancesCall::transfer(33, 0)),
        );
        let x2 = sr_primitives::testing::TestXt(
            sign_extra(1, 2, 0),
            Call::Balances(BalancesCall::transfer(33, 0)),
        );
    ...
    fn validate_unsigned() {
        let xt = sr_primitives::testing::TestXt(
            None,
            Call::Balances(BalancesCall::set_balance(33, 69, 69)),
        );
        let mut t = new_test_ext(1);
