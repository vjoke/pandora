...
pub const VERSION: RuntimeVersion = RuntimeVersion {
    spec_name: create_runtime_str!("node-pandora"),
    impl_name: create_runtime_str!("node-pandora"),
    authoring_version: 3,
    spec_version: 4,
    impl_version: 4,
...
parameter_types! {
    ...
    pub const ReportInterval: BlockNumber = 10;
    pub const ElectionEra: BlockNumber = 10;
    pub const LockedDuration: BlockNumber = 20;
}
...
construct_runtime!(
		...
		UncheckedExtrinsic = UncheckedExtrinsic
	{
		...
		Price: price::{Module, Call, Storage, Event<T>, Config<T>},
	}
);
