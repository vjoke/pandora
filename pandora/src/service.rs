...
use futures::prelude::*;
use pandora_runtime::{self, GenesisConfig, opaque::Block, RuntimeApi};
...
native_executor_instance!(
	pub Executor,
	pandora_runtime::api::dispatch,
	pandora_runtime::native_version,
);
...
macro_rules! new_full_start {
	($config:expr) => {{
		...
		let builder = substrate_service::ServiceBuilder::new_full::<
			pandora_runtime::opaque::Block, pandora_runtime::RuntimeApi, crate::service::Executor
		>($config)?
			...
			.with_import_queue(|_config, client, mut select_chain, transaction_pool| {
				...
				let (block_import, link_half) =
					grandpa::block_import::<_, _, _, pandora_runtime::RuntimeApi, _, _>(
